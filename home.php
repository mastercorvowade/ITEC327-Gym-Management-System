...
.imgs{
	...
	#imagesCarousel,#imagesCarousel .carousel-inner,#imagesCarousel .carousel-item{
		height: 50vh !important;background: black;
	}
...
<div id="container">
<img src="gymback2.jpg" class="center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body bg-secondary">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-university"></i></span>
                                        <h4><b>
                    ...
                    <div class="card">
                                <div class="card-body bg-secondary">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-heartbeat"></i></span>
                                        <h4><b>
                    ...
                    <div class="card">
                                <div class="card-body bg-dark">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-fire"></i></span>
                                        <h4><b>
                        ...
                        <div class="card">
                                <div class="card-body bg-secondary">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-flag"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM payments")->num_rows; ?>
                                        </b></h4>
                                        <p><b> Total Members Validity</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
